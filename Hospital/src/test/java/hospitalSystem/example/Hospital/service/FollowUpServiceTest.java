 ...
 public class FollowUpServiceTest {
     ...
     private hospitalSystem.example.Hospital.service.followUp.FollowUpServiceImpl followUpService;
     ...
     public void setUp() {
         ...
         followUpService = new hospitalSystem.example.Hospital.service.followUp.FollowUpServiceImpl(followUpRepository, userRepository, appointmentRepository);
     }
